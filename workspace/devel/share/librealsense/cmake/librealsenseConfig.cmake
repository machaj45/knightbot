...
if("TRUE" STREQUAL "TRUE")
  set(librealsense_SOURCE_PREFIX /home/knight/workspace/src/librealsense-1.12.1)
  set(librealsense_DEVEL_PREFIX /home/knight/workspace/devel)
  ...
  set(librealsense_INSTALL_PREFIX /home/knight/workspace/install)
...
if(NOT "/home/knight/workspace/src/librealsense-1.12.1/include " STREQUAL " ")
  set(librealsense_INCLUDE_DIRS "")
  set(_include_dirs "/home/knight/workspace/src/librealsense-1.12.1/include")
  ...
  elseif(NOT "http://www.ros.org/wiki/RealSense " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Sergey Dorodnicov <sergey.dorodnicov@intel.com>, Mark Horn <mark.d.horn@intel.com>, Reagan Lopez <reagan.lopez@intel.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'librealsense' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'librealsense' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/knight/workspace/src/librealsense-1.12.1/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${librealsense_dep}_FOUND)
      find_package(${librealsense_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${librealsense_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
