...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/knight/knightbot/our_workspace/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/knight/knightbot/our_workspace/install/lib;/home/knight/knightbot/workspace/devel/lib;/home/knight/git/knightbot/workspace/devel/lib;/opt/ros/kinetic/lib)
